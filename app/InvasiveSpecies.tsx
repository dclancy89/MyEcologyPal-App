...
export default function InvasiveSpecies({ navigation }: any) {
  ...
  const [speciesDetails, setSpeciesDetails] = useState<string>("");
  ...
  const dropdownOptions = [
    { label: InvasiveSpeciesCategory.plant, value: "plant" },
    { label: InvasiveSpeciesCategory.animal, value: "animal" },
  ];
    ...
    <ScrollView style={styles.container} overScrollMode={"never"}>
      ...
      <View style={{ marginBottom: 50 }}>
        ...
        <TextInput
          ...
          onChange={(e) => {
            setSpeciesDetails(e.nativeEvent.text);
          }}
        />
        <View style={{ marginBottom: 20 }}>
          <Button
        ...
        <Button
          ...
          onPress={() => {
            generateMetaData(
              { category: category, description: speciesDetails },
              location.id,
              DataTemplateType.InvasiveSpecies,
              setIsLoading,
              setDataToSave,
              setShowConfirmModal
            );
